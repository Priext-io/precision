...
contract BondEscrow is ReentrancyGuard, Pausable, AccessControl {
    ...
    address public immutable finalityEngine;
    ...
    function slashAndTransfer(
        ...
        bonds.finalized = true;
        finalizationTime[marketID] = block.timestamp;
        delete marketBonds[marketID]; // Clear state to prevent reentrancy + bloat
    ...
    // FIXED: Use finalizationTime as the truth source for cleanup
